...
public class IBOKPSPublicSoap
{
    ...
    public IBOKPSPublicSoap(){}

    public IBOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IBOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IBOExtendedSoapSerializationEnvelope envelope= new IBOExtendedSoapSerializationEnvelope(IBOExtendedSoapSerializationEnvelope.VER11);
