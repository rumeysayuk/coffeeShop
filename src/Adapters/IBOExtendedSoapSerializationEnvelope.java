...
public class IBOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IBODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IBOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IBODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IBODateTimeConverter dateTimeConverter = new IBOStandardDateTimeConverter();

    public IBOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IBOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IBOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IBOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IBOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IBOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
